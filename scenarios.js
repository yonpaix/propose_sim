...
(
	...
	[
		new Scene(3400, [new SceneSound('sounds/kitchen-love', 0)], 
				[new SceneAnimation('images/1-1.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(1800, null,
				[new SceneAnimation('images/1-2.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(2500, null,
				[new SceneAnimation('images/1-3.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(4100, null,
				[new SceneAnimation('images/1-4.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(2600, null,
				[new SceneAnimation('images/1-3.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(1700, null,
				[new SceneAnimation('images/1-5.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(1600, null,
				[new SceneAnimation('images/1-6.jpg', 'zoomin', 'linear', '10s', '0s', 'forwards')]
			),
		new Scene(3000, null,
